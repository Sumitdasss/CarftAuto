...
const HeroBanner = () => {
  ...
  <div className="absolute inset-0 z-0">
    <video
      ...
      muted
      playsInline
      className="h-full w-full object-cover object-center scale-90 sm:scale-95 md:scale-105 opacity-70 md:opacity-60"
    >
      <source
  ...
  {/* 🌑 Responsive Overlays */}
  <div className="absolute inset-0 bg-gradient-to-r from-black/60 md:from-black/80 via-black/35 md:via-black/50 to-black/10 md:to-black/20 z-10" />

  <div className="absolute inset-0 bg-gradient-to-t from-black/50 md:from-black/70 via-transparent to-black/40 md:to-black/60 z-10" />

  {/* ✨ Glow Effects */}
  <div className="absolute top-[-80px] left-[-80px] md:top-[-120px] md:left-[-120px] w-[220px] h-[220px] md:w-[500px] md:h-[500px] bg-orange-500/20 blur-[90px] md:blur-[160px] rounded-full z-10" />

  <div className="absolute bottom-[-80px] right-[-80px] md:bottom-[-120px] md:right-[-120px] w-[220px] h-[220px] md:w-[500px] md:h-[500px] bg-amber-500/10 blur-[90px] md:blur-[180px] rounded-full z-10" />
